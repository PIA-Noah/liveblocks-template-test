...
class ShareSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        if attrs['to_user'] == attrs['from_user']:
            raise serializers.ValidationError("It's no use to share to yourself.")
        if attrs['between_org']:
...
class OrgConRightSerializer(serializers.ModelSerializer):
    class Meta:
        model = OrgConRight
        fields = '__all__'
        read_only_fields = ['id','org','con','is_principal',]
...
class FileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = File
        fields = '__all__'
        read_only_fields = ['id','last_update','is_commented']
    def __init__(self,*args,**kwargs):
        super().__init__(*args,**kwargs)
        if self.instance is not None:
