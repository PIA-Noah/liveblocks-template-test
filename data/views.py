...
from .filters import OrgConFilter,UserConFilter,OrgExerFilter,UserExerFilter

from .permission import IsAdmin as IA,IsPrincipalAndChief as IPAC,IsChief as IC,IsSelf as IS,IsInvited as II
from .permission import CanShare as CS, OrgConPermission as OCP
...
class ShareViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IS,CS]
    def update(self, request, *args, **kwargs):
        return Response({"detail":"Updating share record via this API is not allowed."})
    def destroy(self, request, *args, **kwargs):
